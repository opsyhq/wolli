...
/**
 * wolli's built-in interactive slash commands — the ones `InteractiveMode.handleSubmit`
...
/**
 * wolli's dashboard (home screen) slash commands — the ones `DashboardView.runCommand`
