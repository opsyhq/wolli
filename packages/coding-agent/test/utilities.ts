...
// ============================================================================
// OAuth API key resolution from ~/.steward/agent/auth.json
// ============================================================================
...
/**
 * Resolve API key for a provider from ~/.steward/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.steward/agent/auth.json
 */
...
/** Path to the real steward agent config directory */
export const STEWARD_AGENT_DIR = join(homedir(), CONFIG_DIR_NAME, "agent");

/**
 * Get an AuthStorage instance backed by ~/.steward/agent/auth.json
