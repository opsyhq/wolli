...
function createTempDir(): string {
	// realpathSync resolves the macOS /var/folders → /private/var symlink so the stored
	// session cwd matches the spawned process's process.cwd() (which is realpath-resolved).
