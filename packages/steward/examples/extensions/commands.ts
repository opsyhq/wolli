 ...
 * Commands Extension
 *
 * Demonstrates the steward.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@opsyhq/steward";

export default function commandsExtension(steward: ExtensionAPI) {
	steward.registerCommand("commands", {
